...
def generarReporte():
    ...
    report.drawString(50, 700, "Ernesto Daniel Sánchez Becerra      4CM13        2020630409")
...
print("\tSánchez Becerra Ernesto Daniel \t 4CM13\t 2020630409")
menu()
